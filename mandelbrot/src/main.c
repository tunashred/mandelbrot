...
int main() {
    ...
    mandelbrot_around_center(
        ...
        unu_minus_unu_pe_x, x_patrat_0_1_to_0_2, mandelbrot_quadratic, 4);
    ...
    mandelbrot_around_center( // legacy name: pe_crestele_crapaturii_de_jos
        ...
        sin_x_la_4, unu_minus_unu_pe_x, x_patrat_0_1_to_0_2, mandelbrot_quadratic, 4);
    ...
    mandelbrot_around_center( // legacy name: pene_de_paun
        ...
        1500, 0, 0.8, sin_x_la_4, unu_minus_unu_pe_x, x_patrat_0_1_to_0_2, mandelbrot_quadratic, 6);
