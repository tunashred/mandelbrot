...
int main() {
    ...
    // mandelbrot
    img_info = mandelbrot_around_center(height_landscape, width_landscape, -0.43, -0.1, 1, 1500);
    ...
    // galaxy
    img_info = mandelbrot_around_center(height_portrait, width_portrait, -0.700025 + 0.000000007, -0.26849991525, 0.0000000035, 1500);
    deseneaza_mandelbrot(img_info);
